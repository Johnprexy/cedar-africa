  ...
  <section class="testimonials" id="testimonials">
    <div class="testimonials-inner">
      <div class="t-header">
        ...
        <h2 class="t-title reveal reveal-delay-1">
          Real families.<br/><em>Real homes.</em>
        </h2>
      </div>
      ...
      <div class="t-slider">
        <div class="t-track" :style="{ transform: `translateX(-${active * 100}%)` }">
          <div class="t-card" v-for="(t, i) in testimonials" :key="t.name">
            ...
            <div class="t-author">
              <div class="t-avatar" :style="{ background: t.color }">
                {{ t.name[0] }}
              </div>
              <div>
        ...
        <div class="t-controls">
          <button class="t-btn" @click="prev" @mouseenter="$emit('hover')" @mouseleave="$emit('unhover')">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M16 10H4M10 4L4 10L10 16" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/>
            </svg>
          </button>
          <div class="t-dots">
            <button
          ...
          <button class="t-btn" @click="next" @mouseenter="$emit('hover')" @mouseleave="$emit('unhover')">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
...
const testimonials = [
  ...
  {
    text: "From the first call to handover — 14 months. I expected 24. Their project management is something else. I visited once during construction and I was genuinely impressed by the quality of work.",
